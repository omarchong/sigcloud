            ...
            <div class="modal-body">
                <form action="javascript:void(0)" id="addEditEstatufacturaForm" name="addEditEstatufacturaForm"
                    ...
                    <div class="float-right my-4">
                        <button type="submit" class="btn btn-primary" id="btn-save" value="addNewEstatufactura">Guardar
                        </button>
                    </div>
                </form>
            </div>
...
<script>
    var table = $('#estatufacturas').DataTable({
        "responsive": true,
        "processing": true,
        "serverSide": true,
        "autoWidth": false,
...
<script>
    $(document).ready(function() {
        $("#addEditEstatufacturaForm").validate({
            rules: {
                nombre: {
                    required: true
                }
