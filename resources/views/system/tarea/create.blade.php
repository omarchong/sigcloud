...
<div class="container my-5">
    <div class="card">
        <h4 class="card-header">Agregar tarea</h4>
        <div class="card-body">
            <form action="{{ route('tareas.store') }}" method="POST" id="tareas" class="needs-validation" novalidate>
                @csrf
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="">
                            <input type="date" required class="form-control @error('fecha_limite')  @enderror"
                                value="{{ old('fecha_limite') }}" name="fecha_limite" id="fecha_limite">
                            <div class="valid-feedback">
                                Correcto!
                            </div>
                            @error('fecha_limite')
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="">
                            <input type="time" required class="form-control @error('hora_limite')  @enderror"
                                value="{{ old('hora_limite') }}" name="hora_limite" id="hora_limite">
                            <div class="valid-feedback">
                                Correcto!
                            </div>
                            @error('hora_limite')
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="">
                            <input type="text" required class="form-control @error('tipo_tarea')  @enderror"
                                value="{{ old('tipo_tarea') }}" name="tipo_tarea" id="tipo_tarea">
                            <div class="valid-feedback">
                                Correcto!
                            </div>
                            @error('tipo_tarea')
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="">
                            <select class="form-control  @error('estatutareas_id') is-invalid @enderror"
                                name="estatutareas_id" id="estatutareas_id">
                                @foreach ($estatutareas as $estatutarea)
                                    <option value="{{ $estatutarea->id }}">
                                        {{ $estatutarea->nombre }}
                                    </option>
                                @endforeach
                                <div class="valid-feedback">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="">
                            <input type="hidden" required class="form-control @error('descripcion')  @enderror"
                                value="{{ old('descripcion') }}" id="descripcion" name="descripcion">
